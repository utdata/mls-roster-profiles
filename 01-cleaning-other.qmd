...
> THERE IS A KNOWN ISSUE HERE WHERE PLAYERS ARE DUPLICATED WHEN THEY HAVE MORE THAN ONE DESIGNATION. I'M WORKING ON IT.
...
This is the second file I tackled, so there is more explanation of some techniques in [Cleaning roster](01-cleaning-roster.qmd).
...
This sets the player category. This is fully explained in [the roster cleaning](01-cleaning-roster.qmd).
