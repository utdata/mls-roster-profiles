...
The `others` file hasn't had as much scrutiny. If you see any problems add an issue in Github or ping me on X/Twitter [@crit](https://twitter.com/crit).
...
- ~~[others.csv](data-out/others.csv) include the international slots, designated players, U22 players and unavailable players. This also includes "Notes" designations as outlined below.~~ See above.
